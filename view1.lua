...
function scene:createScene(event)
    ...
    --    local lifetimeValue = 50
    --    local lifetimeValueMin = 100
    --    local lifetimeValueMax = 10000
    --
    --    local function updateDisplay()
    --        --lifetime.text = "Lifetime: " .. lifetimeValueMin + event.target.value * (lifetimeValueMax-lifetimeValueMin)
    --    end
    --
    --    local lifetimeSlider = widget.newSlider()
...
function scene:exitScene(event)
    ...
    for i=1,30 do
        print(Properties[i].name, Sliders[i].slider:getValue())
    end
